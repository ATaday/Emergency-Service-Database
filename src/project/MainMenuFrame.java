...
public class MainMenuFrame {
	...
	public void createMainGUI() {
		...
		JLabel imageLabel = new JLabel(new ImageIcon("src/image.gif"));
		...
		final JButton eventButton = new JButton("Event Information");
		...
		final JButton organisationButton = new JButton("Organisation Information");
		...
		final JButton peopleButton = new JButton("People Information");
		...
		final JButton vehicleButton = new JButton("Vehicle Information");
